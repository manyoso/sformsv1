...
ClassFunctionDeclaration::ClassFunctionDeclaration(AST *node, Range * range, DUContext* context)
  : ClassMemberDeclaration(node, range, context)
...
/*bool ClassFunctionDeclaration::isSimilar(CodeItem *other, bool strict ) const
{
