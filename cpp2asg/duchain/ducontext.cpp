...
DUContext::DUContext(AST *node, Range* range, DUContext* parent)
  : DUChainBase(node, range)
  , m_contextType(Other)
  , m_parentContext(0)
...
QList<Declaration*> DUContext::findLocalDeclarations( const QualifiedIdentifier& identifier, const Cursor & position, const AbstractType::Ptr& dataType, bool allowUnqualifiedMatch ) const
{
  ENSURE_CHAIN_READ_LOCKED
...
void DUContext::findLocalDeclarationsInternal( const QualifiedIdentifier& identifier, const Cursor & position, const AbstractType::Ptr& dataType, bool allowUnqualifiedMatch, QList<Declaration*>& ret ) const
{
...
void DUContext::findDeclarationsInternal( const QualifiedIdentifier & identifier, const Cursor & position, const AbstractType::Ptr& dataType, QList<UsingNS*>& usingNS, QList<Declaration*>& ret, bool inImportedContext ) const
{
...
QList<Declaration*> DUContext::findDeclarations( const QualifiedIdentifier & identifier, const Cursor & position, const AbstractType::Ptr& dataType) const
{
  ENSURE_CHAIN_READ_LOCKED
...
DUContext * DUContext::findContext( const Cursor& position, DUContext* parent) const
{
  ENSURE_CHAIN_READ_LOCKED
...
QHash<QualifiedIdentifier, Declaration*> DUContext::allDeclarations(const Cursor& position) const
{
  ENSURE_CHAIN_READ_LOCKED
...
void DUContext::mergeDeclarationsInternal(QHash<QualifiedIdentifier, Declaration*>& definitions, const Cursor& position, bool inImportedContext) const
{
...
DUContext::UsingNS::UsingNS(Cursor* cursor)
  : DocumentCursorObject(cursor)
{
}

void DUContext::addUsingNamespace(Cursor* cursor, const QualifiedIdentifier& id)
{
  ENSURE_CHAIN_WRITE_LOCKED
...
QList<Declaration*> DUContext::findDeclarations(const Identifier& identifier, const Cursor& position) const
{
  ENSURE_CHAIN_READ_LOCKED
...
QList<DUContext*> DUContext::findContexts(ContextType contextType, const QualifiedIdentifier& identifier, const Cursor& position) const
{
  ENSURE_CHAIN_READ_LOCKED
...
void DUContext::findContextsInternal(ContextType contextType, const QualifiedIdentifier& identifier, const Cursor& position, QList<UsingNS*>& usingNS, QList<DUContext*>& ret, bool inImportedContext) const
{
  if (contextType == type())
...
DUContext * DUContext::findContextAt(const Cursor & position) const
{
  ENSURE_CHAIN_READ_LOCKED
...
Use* DUContext::findUseAt(const Cursor & position) const
{
  ENSURE_CHAIN_READ_LOCKED
...
void DUContext::acceptUsingNamespaces(const Cursor & position, QList< UsingNS * > & usingNS) const
{
